...
class CleanBoxMetaBox {
	...
	*/
	public function show() {
	    ...
	    <div id="clean-box-ui-tabs" class="ui-tabs">
		    <ul class="clean-box-ui-tabs-nav" id="clean-box-ui-tabs-nav">
		    	<li><a href="#frag1"><?php _e( 'Layout Options', 'clean-box' ); ?></a></li>
		    	<li><a href="#frag3"><?php _e( 'Header Featured Image Options', 'clean-box' ); ?></a></li>
		    	<li><a href="#frag4"><?php _e( 'Single Page/Post Image Layout ', 'clean-box' ); ?></a></li>
		    </ul> 
		    <div id="frag1" class="catch_ad_tabhead">
		    	<table id="layout-options" class="form-table" width="100%">
		            <tbody>
		                <tr>
		                    <select name="clean-box-layout-option" id="custom_element_grid_class">
		      					<?php  
			                    foreach ( $layout_options as $field ) {  
			                        $metalayout = get_post_meta( $post->ID, 'clean-box-layout-option', true );
			                        if( empty( $metalayout ) ){
			                            $metalayout='default';
			                        }
			                   	?>
